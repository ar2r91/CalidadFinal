            ...
            <table class="table">
                <tr>
                    <td>
                        ...
                        <a href="/admRegistrarMedicion" style="color: #509f0c">Agregar Equipo Medicion</a>
                    </td>
                </tr>
                <tr>
                    <td>
...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="panel-heading"><h3>Agregar Equipo Medicion</h3></div>
            <form name="form" action="{{url('MedicionRegistrado')}}" role="Form" method="POST" class="Horizontal">
                {{csrf_field()}}
                @if(session()->has('true'))
                        ...
                        <div class=" row ">
                            ...
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                ...
                                <input class="form-control input-sm" name="marca" id="marca"
                                       ...
                                       required placeholder="Ejem: Marca">
                            </div>
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                ...
                                <input class="form-control input-sm" name="modelo" id="modelo"
                                       ...
                                       required placeholder="Ejem: Modelo">
                            </div>
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                        ...
                        <div class=" row ">
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                ...
                                <input class="form-control input-sm" id="datepicker"
                                       autocomplete="off" required name="fecha">
                                <script>
                                    $( function() {
