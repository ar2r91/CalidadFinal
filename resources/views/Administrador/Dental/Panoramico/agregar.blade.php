            ...
            <table class="table">
                <tr>
                    <td>
                        ...
                        <a href="/admRegistrarPanoramico" style="color: #509f0c">Agregar Panaromico y Cefalometrico</a>
                    </td>
                </tr>
                <tr>
                    <td>
...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="panel-heading"><h3>Agregar Dental-Panoramico</h3></div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                <span class="control-label">Gantry gira libremente:</span>
                                <div class="row">
                                    <div class="col-sm-10">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-10 col-xs-5 col-lg-4 form-group-sm ">
                                <span class="control-label glyphicon glyphicon-ok"> Alineamiento tubo-receptor de imagen</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <select class="form-control " name="alineamiento"
                                                id="alineamiento" required>
                                            <option selected disabled>Aceptable? SI/NO</option>
                                            <option>SI</option>
                                            <option>NO</option>
                                        </select>
                                    </div>
