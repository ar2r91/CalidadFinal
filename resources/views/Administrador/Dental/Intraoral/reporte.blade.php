@if(isset($dental))
    @foreach($dental as $d)
        <head>
            <div align="right">Nº {{$d->codDental}} - (Pagina 1 de 3)</div>
        ...
        <body>
        <BR>
        <div>1. Fecha: {{$d->dfecha}}</div>
        <br>
        <div>2. DATOS DEL SOLICITANTE</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Razon Social: {{$d->razonSocial}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;RUC: {{$d->ruc}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Direccion: {{$d->direccion}}</div>
        <br>
        ...
        <div align="right">Nº {{$d->codDental}} - (Pagina 2 de 3)</div>
        <div>6. EQUIPO EMPLEADO</div>
        <br>
        <table style="width:100%" border="1">
            <tr>
                <th></th>
                <th align="center">{{$d->tipo}}</th>
            </tr>
            <tr>
                <th>Marca:</th>
                <th align="center">{{$d->mmarca}}</th>
            </tr>
            <tr>
                <th>Modelo:</th>
                <th align="center">{{$d->mmodelo}}</th>
            </tr>
            <tr>
                <th>Serie:</th>
                <th align="center">{{$d->mserie}}</th>
            </tr>
            <tr>
                <th>Fecha de calibracion:</th>
                <th align="center">{{Carbon\Carbon::parse($d->mfecha)->format('d-m-Y')}}</th>
            </tr>
        </table>
        <br>
        ...
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Estabilidad mecanica: {{$d->estabilidadmecanica}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Movimientos adecuados del equipo: {{$d->movimientoequipo}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Buen estado de los cables (alta tencion y
            alimentacion): {{$d->estadocables}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Existe indicador de punto focal: {{$d->grantygira}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Los indicadores de tecnicas de exposcion en el panel de control funcionan
            adecuadamente: {{$d->indicadoresoperativos}}
        </div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Existe señal audible durante y/o al final de la
            exposicion: {{$d->sistemaaudible}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;El interruptor de exposicion es del tipo hombre-muerto: Si</div>
        <br>
        <div>7.2. PRUEBAS</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.1. Minima distancia foco-piel</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->pdistancia}} cm</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &gt;= 20 cm</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptabled ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.2. Tamaño del campo en el extremo del localizador</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->tamanio}} cm</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt;= 6 cm</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptablet ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.3. Exactitud de la tension</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultadotn}}%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt;= ± 10%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptabletn ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.4. Repetibilidad de la tension</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultadot}}%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt;= 10 %</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->cvaloraceptablet ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.5. Filtracion</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->filtracion}} mm equivalente de aluminio
        </div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &gt;= 1.5 mm aluminio</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptablef ==1)Si @else
                No @endif</div>
        <br>
        <div align="right">Nº {{$d->codDental}} - (Pagina 3 de 3)</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.6. Exactitud del tiempo de aluminio</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultadoti}}%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt;= ±20%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptableti ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.7. Repetibilidad del tiempo de exposicion</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultadotie}}%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt;= ±10%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptabletie ==1)Si @else
                No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.8. Variacion del rendimiento</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultador}}%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: &lt; 10%</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->aceptabler ==1)Si @else No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.9. Variacion del rendimiento con el tiempo de exposicion
        </div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->resultadoc}}</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tolerancia: Coeficiente de linealidad &lt; 0.1</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->aceptablec ==1)Si @else No @endif</div>
        <br>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.10. Dosis en la superficie del paciente</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exploracion: Molar Superior Adulto</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Distancia Foco-Piel: {{$d->ddistancia}} cm/
            Tensión: {{$d->dtension}} kV/ Corriente: {{$d->dcorriente}} mA/ Tiempo de
            Exposición: {{$d->dtiempoexposicion}} ms
        </div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resultado: {{$d->dosis}} mGy</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Referencia: 7 mGy</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aceptable: @if($d->valoraceptable ==1)Si @else
                No @endif</div>
        <br>
