        ...
        <div class="row">
            ...
            @if($cliente)
                @foreach($cliente as $c)
                    <form name="form" action="{{ url('ClienteEditado/' .$c->codCliente)}}" role="Form"
                          class="Horizontal">
                        {{csrf_field()}}
                        @if(session()->has('true'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                        ...
                                        <input class="form-control input-sm" name="telefono" type="text" id="telefono"
                                               ...
                                               placeholder="Ejm: 987654321" value="{{$c->telefono}}">
                                        <span style="color: red" class=" control-label" id="spanruc"></span>
                                    </div>
                                    <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm">
                                        ...
                                        <input class="form-control input-sm" name="email" type="email" id="email"
                                               ...
                                               autocomplete="off" onchange="validarCorreo('email','spanemail')"
                                               required value="{{$c->email}}">
                                ...
                                <div class=" row ">
                                    ...
                                    <div class="col-sm-10 col-xs-5 col-lg-3 form-group-sm ">
                                        ...
                                        <textarea class="form-control input-sm" name="detalle" id="detalle"
                                                  autocomplete="off"
                                                  placeholder="Ejm: Detalle">{{$c->detalle}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
